        ...
        "unit_list": [  # unit_list ?°ì„  ?•ì¸
            {
                "runes": [
                    ...
                    {
                        "rune_id": 100,  # ì¤‘ë³µ (rune_list?ë„ ?ˆìŒ)
                        "slot_no": 1,
                        "set_id": 5,
                        "pri_eff": [4, 63],
                        "sec_eff": [],
